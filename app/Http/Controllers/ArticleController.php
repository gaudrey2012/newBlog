...
class ArticleController extends Controller
{
    ...
    public function update(ArticleRequest $request, Article $article)
    {
        ...
        return redirect()->route('articles.index')->with('success', "l'article a été bien modifie");
    }
    ...
    {
        $article->delete();
        return redirect()->route('articles.index')->with('success', "l'article a bien été supprimée");
    }
}
